...
public class PurchaseController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:purchase:list")
    ...
    //@RequiresPermissions("coupon:purchase:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupon:purchase:save")
    ...
    //@RequiresPermissions("coupon:purchase:update")
    ...
    //@RequiresPermissions("coupon:purchase:delete")
