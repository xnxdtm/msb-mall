...
public class WareSkuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:waresku:list")
    ...
    //@RequiresPermissions("coupon:waresku:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupon:waresku:save")
    ...
    //@RequiresPermissions("coupon:waresku:update")
    ...
    //@RequiresPermissions("coupon:waresku:delete")
