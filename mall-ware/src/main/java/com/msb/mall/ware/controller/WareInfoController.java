...
public class WareInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("coupon:wareinfo:list")
    ...
    //@RequiresPermissions("coupon:wareinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("coupon:wareinfo:save")
    ...
    //@RequiresPermissions("coupon:wareinfo:update")
    ...
    //@RequiresPermissions("coupon:wareinfo:delete")
